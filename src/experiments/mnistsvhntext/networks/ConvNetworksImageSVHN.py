...
class EncoderSVHN(Encoder):
    def __init__(self, flags):
        ...
        if flags.factorized_representation:
            ...
            # class
            self.class_mu = nn.Linear(in_features=128, out_features=class_dim, bias=True)
            self.class_logvar = nn.Linear(in_features=128, out_features=class_dim, bias=True)
        else:
            #non-factorized
            self.hidden_mu = nn.Linear(in_features=128, out_features=class_dim, bias=True)
            self.hidden_logvar = nn.Linear(in_features=128, out_features=class_dim, bias=True)
