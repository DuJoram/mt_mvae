...
class Text(Modality):
    def __init__(
        ...
        super(Text, self).__init__(name="text", likelihood="categorical")
    ...
    def save_data(self, samples, fn, args):
        write_samples_text_to_file(
            tensor_to_text(self.alphabet, samples.unsqueeze(0)), fn
        )
